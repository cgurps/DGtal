...
int main()
{
  ...
  BOOST_CONCEPT_ASSERT(( ALboost::AssociativeContainer< MyLabelledMap > ));
  BOOST_CONCEPT_ASSERT(( ALboost::PairAssociativeContainer< MyLabelledMap > ));
  BOOST_CONCEPT_ASSERT(( ALboost::UniqueAssociativeContainer< MyLabelledMap > ));
